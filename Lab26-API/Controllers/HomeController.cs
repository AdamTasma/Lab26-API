...
namespace Lab26_API.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult GetWeatherData()
        {
            ...
            HttpWebRequest request = WebRequest.CreateHttp("https://forecast.weather.gov/MapClick.php?lat=42.963360&lon=-85.668086&FcstType=json");
            ...
            ViewBag.r = region;
            JToken LocationInfo = o["location"]["areaDescription"];
            ViewBag.l = LocationInfo;
        ...
        public ActionResult LatLong(double latt, double longg)
        {
            ViewBag.latt = latt;
            ViewBag.longg = longg;

            string lattt = latt.ToString();
            string longgg = longg.ToString();
            ...
            HttpWebRequest request = WebRequest.CreateHttp("https://forecast.weather.gov/MapClick.php?lat=" + lattt + "&lon=" + longgg + "&FcstType=json");
            request.UserAgent = @"User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.116 Safari/537.36";
            HttpWebResponse response = (HttpWebResponse)request.GetResponse();
        ...
        public ActionResult LocationPicker()
        {
            return View();
        }

        public ActionResult LocationResult()
        {
            return View();
        }
    }
